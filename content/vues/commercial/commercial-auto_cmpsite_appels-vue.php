...
if(isset($_SESSION['user'])) {
    ...
    if($_SESSION['user']['profile']==sha1(md5('commercial'.$salt)) ){ 
        if(isset($_POST['campagnetest']))
        {
            ...
            $remplir=$remplir->updatecampagne_auto_cmp_site($_POST['campagnetest'],$_POST['observation'],$_POST['ntel'],$_POST['nemail']
        ...
        if(isset($_POST['campagne']))
        {
            ...
            require('content/controller/class.remlpiration.php');
            $remplir=new rempliration();
            $remplir=$remplir->get_auto_campagne_site($_POST['campagne'],$_POST['type_contact']);
            echo $remplir;
            exit;
        }
    ...
    <script>
        getfichecontact_auto_cmp("<?php echo $_GET['Campagne']; ?>",1,"","<?php echo $_GET['type_contact']; ?>");
