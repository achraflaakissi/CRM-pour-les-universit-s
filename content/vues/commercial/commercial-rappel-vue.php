...
if(isset($_SESSION['user'])) {
    ...
    if($_SESSION['user']['profile']==sha1(md5('commercial'.$salt)) ){
        ...
        if(isset($_POST['campagnetest']))
        {
            ...
            $remplir=$remplir->updatecampagnerappel($_POST['type'],$_POST['idid'],$_POST['etapephoning'],$_POST['observation'],$_POST['ntel'],$_POST['nemail']
                ,$_POST['s1tc'],$_POST['s2tc'],$_POST['annuelletc'],$_POST['s1bac1']
        ...
        if(isset($_POST['auth']))
        {
            ...
            require('content/controller/class.remlpiration.php');
            $remplir=new rempliration();
            $remplir=$remplir->getcontactrappel($_POST['auth'],$_POST['type']);
            echo $remplir;
            exit;
        }
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <textarea style="margin-top: 10px" id="observation_ans" class="form-control col-md-6" rows="5" readonly cols="5" placeholder="Observation..."></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Suivi Par : </label>
                                    <div class="input-group">
                                        <input class="form-control col-md-6" style="width : 100%;" id="contact_suivi_par" type="text" readonly="">
                                    </div>
                                </div>
    ...
    document.getElementById("rdv_non").checked = false;
        ...
        getfichecontactrappel("<?php echo $_GET['auth']; ?>",1,"<?php echo $_GET['type']; ?>");
