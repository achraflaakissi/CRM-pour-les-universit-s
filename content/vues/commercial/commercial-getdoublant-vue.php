...
$remplir=$remplire->getdoublantcontactdirect();
if(isset($_POST['auth_']) and !empty($_POST['auth_']))
{
    header('Content-Type: application/json');
    $result=$remplire->update_cd_for_doubl("CD",$_POST['auth_'],$_POST['Nom'],
...
{
    header('Content-Type: application/json');
    $result=$remplire->delete_cd_for_doubl("CD",$_POST['auth_delete_']);
    echo $result;exit;
}
if(isset($_POST['auth']) and !empty($_POST['auth']) and isset($_POST['auth1']) and !empty($_POST['auth1']))
{
    header('Content-Type: application/json');
    $result=$remplire->get_cd_for_doubl($_POST['auth'],$_POST['auth1']);
    echo $result;exit;
}
if(isset($_POST['auth_validation']) and !empty($_POST['auth_validation']))
{
    header('Content-Type: application/json');
    $result=$remplire->validation_direct_contact($_POST['auth_validation']);
    echo $result;exit;
}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box-body">
                                ...
                                <div class="form-group" style="width: 100% !important;">
                                    <label class="text-danger">Formation demandee</label>
                                    <input type="text" class="form-control" name="groupe_foramation" id="groupe_foramation">

                                </div><!-- /.form-group -->
                                <div class="form-group" style="width: 100% !important;">
                                    <label for="formationdemandee" class="text-danger">Niveau demandee</label>
                                ...
                                <div class="form-group">
                                    <label for="adresse">Test Passé</label>
                                    <input readonly class="form-control" rows="5" name="test_passe" id="test_passe"/>
                                </div>

                                <div class="form-group">
                                    <label for="adresse">Test</label>
                                    <input readonly class="form-control" rows="5" name="test" id="test"/>
                                </div>
                                
                                <div class="form-group">
                                    <label for="adresse">Dépôt dossier</label>
                                    <input readonly class="form-control" rows="5" name="depot_dossier" id="depot_dossier"/>
                                </div>
                                
                                <div class="form-group">
                                    <label for="adresse">Date Dépôt</label>
                                    <input readonly class="form-control" rows="5" name="date_depot" id="date_depot"/>
                                </div>
                                
                                <div class="form-group">
                                    <label for="adresse">Frais Dossier</label>
                                    <input readonly class="form-control" rows="5" name="frais_dossier" id="frais_dossier"/>
                                </div>
                                
                                <div class="form-group">
                                    <label for="adresse">Date Frais</label>
                                    <input readonly class="form-control" rows="5" name="date_frais" id="date_frais"/>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="box-body">
                                ...
                                <div class="form-group" style="width: 100% !important;">
                                    <label class="text-danger">Formation demandee</label>
                                    <input type="text" class="form-control" name="groupe_foramationa" id="groupe_foramationa">
                                ...
                                <div class="form-group">
                                    <label for="adresse">Test Passé</label>
                                    <input readonly class="form-control" rows="5" name="test_passea" id="test_passea" />
                                </div>

                                <div class="form-group">
                                    <label for="adresse">Test</label>
                                    <input readonly  class="form-control" rows="5" name="testa" id="testa" />
                                </div>
                                
                                <div class="form-group">
                                    <label for="adresse">Dépôt dossier</label>
                                    <input readonly  class="form-control" rows="5" name="depot_dossiera" id="depot_dossiera" />
                                </div>
                                
                                <div class="form-group">
                                    <label for="adresse">Date Dépôt</label>
                                    <input readonly  class="form-control" rows="5" name="date_depota" id="date_depota"/>
                                </div>
                                
                                <div class="form-group">
                                    <label for="adresse">Frais Dossier</label>
                                    <input readonly  class="form-control" rows="5" name="frais_dossiera" id="frais_dossiera"/>
                                </div>
                                
                                <div class="form-group">
                                    <label for="adresse">Date Frais</label>
                                    <input readonly  class="form-control" rows="5" name="date_fraisa" id="date_fraisa"/>
                                </div>
