...
//        and !empty($_POST['content_email']) and !empty($_POST['emailto'])
        ...
        if(isset($_POST['campagnetest']))
        {
            ...
            $remplir=$remplir->updatecampagnecaravane($_POST['campagnetest'],$_POST['observation'],$_POST['ntel'],$_POST['nemail']
...
<p>C&rsquo;est M. Mlle &hellip;&nbsp;?</p>

<p>C&rsquo;est l&rsquo;universit&eacute; priv&eacute;e de Marrakech &agrave; l&rsquo;appareil</p>

<p>Je vous appelle pour vous informer que nous serons &agrave; (Ville) du (date &agrave; date juillet) dans le cadre de la caravane nationale des inscriptions que nous organisons.</p>

<p>Nos responsables des admissions et orientateurs seront pr&eacute;sents &agrave; (ville) pour vous aider dans le choix de votre parcours d&rsquo;&eacute;tudes. Ils vous donneront &eacute;galement des informations sur les d&eacute;bouch&eacute;s m&eacute;tiers, c&rsquo;est-&agrave;-dire tout ce que vous pourrez faire comme m&eacute;tier avec le dipl&ocirc;me UPM. Et ils vous accompagneront dans votre d&eacute;marche d&rsquo;inscription.</p>

<p>Les rencontres se font sur rendez-vous et je voulais savoir si vous souhaitez recevoir une invitation et prendre RDV avec nos &eacute;quipes.</p>

<p>Si OUI&nbsp;: je vous envoie le lien pour que vous puissiez demander votre invitation</p>

<p>Je confirme avec vous votre adresse email&nbsp;? c&rsquo;est bien&hellip;&hellip;&nbsp;?</p>

<p>OK je vous envoie le lien tout de suite. N&rsquo;attendez pas pour demander votre invitation</p>

<p>Si NON&nbsp;: &nbsp;Puis-je conna&icirc;tre la raison&nbsp;?</p>

<p>Veiller &agrave; d&eacute;tecter le ou&nbsp; les points bloquants , ex.&nbsp;:</p>

<ul>
	<li>Choix autre &eacute;tablissement&nbsp;? Lequel&nbsp;? inscrit ou pas encore&nbsp;?</li>
	<li>Si pas encore&nbsp;: si public, pourquoi&nbsp;? Et rappeler que notre universit&eacute; est reconnue et que nos dipl&ocirc;mes sont &eacute;quivalents aux dipl&ocirc;mes de l&rsquo;&eacute;tat. Essayer toujours de d&eacute;crocher un RDV</li>
	<li>&Eacute;tudes &agrave; l&rsquo;&eacute;tranger&nbsp;: essayer toujours de d&eacute;crocher le OUI en mettant l&rsquo;accent sur nos parcours internationaux</li>
	<li>Si autre &eacute;tablissement priv&eacute;, insister pour un OUI pour lui d&eacute;montrer que nous sommes les meilleurs&hellip;</li>
	<li>Probl&egrave;me financier&nbsp;? Rappeler que nous avons un service d&rsquo;aide au financement et qu&rsquo;il trouvera la solution en rencontrant nos &eacute;quipes sur place</li>
	<li>Autres raisons&nbsp;? &hellip;.</li>
</ul>

<p>&nbsp;</p>

<p>Il est important de d&eacute;tecter les points bloquants, et d&eacute;crocher avec l&rsquo;accord du prospect le OUI pour RDV avec les responsables sur place.</p>

<p>Si pas de OUI, l&rsquo;inviter &agrave; visiter quand m&ecirc;me notre site web upm.ac.ma et l&rsquo;inviter &eacute;galement &agrave; passer nous voir lorsque nous serons dans la ville, cela lui permettra d&rsquo;avoir des informations avant de faire son choix.</p>

<p>Fin de la communication</p>

<p>La communication devra &ecirc;tre br&egrave;ve et concluante</p>
