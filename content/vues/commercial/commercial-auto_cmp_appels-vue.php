...
if(isset($_SESSION['user'])) {
    ...
    if($_SESSION['user']['profile']==sha1(md5('commercial'.$salt)) ){ 
        if(isset($_POST['campagnetest']))
        {
            ...
            $remplir=$remplir->updatecampagne_auto_cmp_appel($_POST['campagnetest'],$_POST['observation'],$_POST['ntel'],$_POST['nemail']
        ...
        if(isset($_POST['campagne']))
        {
            ...
            require('content/controller/class.remlpiration.php');
            $remplir=new rempliration();
            $remplir=$remplir->get_auto_campagne($_POST['campagne'],$_POST['type_contact']);
            echo $remplir;
            exit;
        }
