...
if(isset($_SESSION['user'])) {
    ...
    if($_SESSION['user']['profile']==sha1(md5('commercial'.$salt)) ){
        ...
        if(isset($_POST["agents_myarray"]))
        {
            ...
            $test=$rempisage->create_demande_cmp($_POST["myarray"],$_POST['nomcompagne_myarray'],$_POST['typecontact_myarray'],$_POST['etatphoning'],$_POST['script'],$_POST['email_cmp'],$_POST['ObservationEmail_cmp']);
            echo $test;exit;
            exit;
        }
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" onchange="vidercontent();" class="form-control" id="nomcompagne" placeholder="Nom de campagne ...">
                                                            ...
                                                            <input type="hidden" multiple="multiple" id="agents" value="*">
                                        </div><!-- /.col -->
                                    </div><!-- /.row -->
                                     </div>
                                    <div class="row">
