...
if(isset($_SESSION['user'])) {
    ...
    if($_SESSION['user']['profile']==sha1(md5('saisie'.$salt)) ){
        ...
        if(isset($_POST["agents"]))
        {
            ...
            $getlistcontact=$rempisage->getlistecontactbyuser($_POST["agents"],$_POST["anneeuniver"],$_POST["typecontactlist"],$_POST["formation"],$_POST["marche"],$_POST["etatphoning"],$_POST["agents_autorisation"]);
